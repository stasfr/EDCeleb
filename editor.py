...
def edit_img(text):
  ...
  fontsize = 1
  img_fraction = 0.70
  font = ImageFont.truetype('Fonts/TOYZ.ttf', size=fontsize, encoding='UTF-8')
  ...
  I1.text(((width-wTop)/2, (height-hTop)/15), phraseTop, font=font, stroke_width=2, stroke_fill='black', fill='#6B3074')
  I1.text(((width-wBottom)/2, (height-hBottom)/1.1), phraseBottom, font=font, stroke_width=2, stroke_fill='black', fill='#6B3074')
